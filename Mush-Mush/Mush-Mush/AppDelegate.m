...
//    Marker* marker = [[Marker alloc] initWithName:@"Name333" descript:@"desct" year:@"2018" mushroomsWeight:@"100" x:@"2" y:@"1"];
//    Marker* marker2 = [[Marker alloc] initWithName:@"Name2222" descript:@"desct2" year:@"2000" mushroomsWeight:@"77" x:@"10" y:@"3"];
